...
from .newblock import DeformConv, DeformConvdouble
class MSD(nn.Module):  # Ours
    ...
    def __init__(self, nf=64, groups=8, dilation=1):
        ...
        self.dcnpack = DeformConvdouble(nf, (3,3), padding=1, stride=1, dilation=dilation, groups=groups)
...
class TDAN_align(nn.Module):  # TDA used in TDAN
    def __init__(self, nf=64, groups=8):
        ...
        self.dconv_1 = DeformConv(64, (3, 3), stride=1, padding=1, dilation=1, groups=groups)
        self.off2d_2 = nn.Conv2d(64, 18 * 8, 3, padding=1, bias=True)
        self.deconv_2 = DeformConv(64, (3, 3), stride=1, padding=1, dilation=1, groups=groups)
        self.off2d_3 = nn.Conv2d(64, 18 * 8, 3, padding=1, bias=True)
        self.deconv_3 = DeformConv(64, (3, 3), stride=1, padding=1, dilation=1, groups=groups)
        self.off2d = nn.Conv2d(64, 18 * 8, 3, padding=1, bias=True)
        self.dconv = DeformConv(64, (3, 3),stride=1, padding=1, dilation=1, groups=groups)
...
class PCD_Align(nn.Module):  # PCD used in EDVR
    ...
    def __init__(self, nf=64, groups=8):
        ...
        self.L3_dcnpack = DeformConv(nf, (3, 3), stride=1, padding=1, dilation=1,
                                  groups=groups)
        # L2: level 2, 1/2 spatial size
        self.L2_offset_conv1 = nn.Conv2d(nf * 2, nf, 3, 1, 1, bias=True)  # concat for diff
        self.L2_offset_conv2 = nn.Conv2d(nf * 2, nf, 3, 1, 1, bias=True)  # concat for offset
        self.L2_offset_conv3 = nn.Conv2d(nf, nf, 3, 1, 1, bias=True)
        self.L2_dcnpack = DeformConv(nf, (3, 3), stride=1, padding=1, dilation=1,
                                  groups=groups)
        ...
        self.L1_dcnpack = DeformConv(nf, (3, 3), stride=1, padding=1, dilation=1,
                                  groups=groups)
        ...
        self.cas_dcnpack = DeformConv(nf, (3, 3), stride=1, padding=1, dilation=1,
                                   groups=groups)
